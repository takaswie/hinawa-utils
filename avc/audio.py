...
class AvcAudio():
    ...
    @staticmethod
    def set_selector_param(unit, subunit_id, attr, fb_id, value):
        if subunit_id > 0x07:
    ...
    def get_selector_param(unit, subunit_id, attr, fb_id):
        if subunit_id > 0x07:
            raise ValueError('Invalid argument for subunit ID')
        if ('current', 'minimum', 'maximum', 'default').count(attr) == 0:
            raise ValueError('Invalid argument for attribute')
    ...
    def set_feature_mute_param(unit, subunit_id, attr, fb_id, ch, mute):
        if subunit_id > 0x07:
            raise ValueError('Invalid argument for subunit ID')
    ...
    def get_feature_mute_param(unit, subunit_id, attr, fb_id, ch):
        if subunit_id > 0x07:
            raise ValueError('Invalid argument for subunit ID')
        if attr is not 'current':
            raise ValueError('Invalid argument for attribute')
    ...
    def set_feature_volume_param(unit, subunit_id, attr, fb_id, ch, vol):
        if subunit_id > 0x07:
            raise ValueError('Invalid argument for subunit ID')
    ...
    def get_feature_volume_param(unit, subunit_id, attr, fb_id, ch):
        if subunit_id > 0x07:
            raise ValueError('Invalid argument for subunit ID')
        if AvcAudio.attributes.count(attr) == 0:
            raise ValueError('Invalid argument for attribute')
    ...
    def set_feature_lr_param(unit, subunit_id, attr, fb_id, ch, balance):
        if subunit_id > 0x07:
            raise ValueError('Invalid argument for subunit ID')
        if AvcAudio.attributes.count(attr) == 0:
            raise ValueError('Invalid argument for attribute')
    ...
    def get_feature_lr_param(unit, subunit_id, attr, fb_id, ch):
        if subunit_id > 0x07:
            raise ValueError('Invalid argument for subunit ID')
        if AvcAudio.attributes.count(attr) == 0:
            raise ValueError('Invalid argument for attribute')
    ...
    def set_processing_mixer_param(unit, subunit_id, attr, fb_id, in_fb,
    ...
    def get_processing_mixer_param(unit, subunit_id, attr, fb_id, in_fb,
                                   in_ch, out_ch):
        attrs = ('current', 'minimum', 'maximum', 'resolution', 'default')
        if subunit_id > 0x07:
            raise ValueError('Invalid argument for subunit ID')
